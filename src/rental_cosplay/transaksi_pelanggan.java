 ...
 * @author couser
 */
public class transaksi_pelanggan extends javax.swing.JFrame {
    ...
    class transaksi extends transaksi_pelanggan {
...
public void simpanTransaksi() {
    ...
    private void initComponents() {
        ...
        setTitle("Transaksi Pelanggan");
        getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        text_id_transaksi.setEnabled(false);
        getContentPane().add(text_id_transaksi, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 130, 660, 60));
        ...
        getContentPane().add(text_nama_pelanggan, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 200, 660, 60));
        ...
        getContentPane().add(combo_kostum, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 270, 460, 50));

        text_lama_sewa.setFont(new java.awt.Font("Arial", 0, 24)); // NOI18N
        getContentPane().add(text_lama_sewa, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 390, 660, 60));

        text_total.setFont(new java.awt.Font("Arial", 0, 24)); // NOI18N
        text_total.setEnabled(false);
        getContentPane().add(text_total, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 460, 660, 60));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 710, 830, 380));
        ...
        getContentPane().add(combo_pembayaran, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 530, 370, 60));

        btn_input.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        ...
        getContentPane().add(btn_input, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 630, 140, 50));

        text_tanggal.setFont(new java.awt.Font("Arial", 0, 24)); // NOI18N
        getContentPane().add(text_tanggal, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 330, 660, 50));

        btn_kembali.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        ...
        getContentPane().add(btn_kembali, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 20, 150, 70));

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Transaksi pelanggan [35448ED].png"))); // NOI18N
    ...
    private void btn_kembaliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_kembaliActionPerformed
        // TODO add your handling code here:
        Menu_pelanggan tran = new Menu_pelanggan();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(transaksi_pelanggan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new transaksi_pelanggan().setVisible(true);
            }
        });
    }
